...
private:
    ...
    template<typename T> void loadNonVerticallyIntegratedRanges(T *boundaryCondition);
    ...
    template<typename T> void saveNonVerticallyIntegratedRanges(T *boundaryCondition);
